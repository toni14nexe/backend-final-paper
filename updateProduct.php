<?php
    ...
    $sql = "UPDATE `PurpleProducts` SET `name`='$name',`price`='$price',`description`='$description',`type`='$type' WHERE id='$id'";
    ...
    //https://toni-web.com/thepurplehat/updateProduct.php?id=1000&price=2&inStock=99&description=desc&sold=1&type=grill&mainType=food
?>